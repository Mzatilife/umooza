<div class="bg-light">
  <footer class="py-3 my-4">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      ...
      <li class="nav-item"><a href="includes/about.inc.php" class="nav-link px-2 text-muted">About</a></li>
      <li class="nav-item"><a href="includes/help.inc.php" class="nav-link px-2 text-muted">Help</a></li>
      <li class="nav-item dropdown">
