        ...
        try {
            ...
            if ($send) {
                ...
                if (in_array($file_extension, $valid_ext)) {
                    ...
                    $msg = $register->userRegistration($fname, $lname, $phone, $phone2, $email, $address, $new_name, $pass1, 'customer', $token);
                } else {
        ...
        <div class="container">
            <div class="card">
                <div class="card-body bg-primary text-center">
                    <h5 class="card-title text-white">Fill in the form fields to create a customer account.</h5>
                </div>
            </div>
            <hr>
