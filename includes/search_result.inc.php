...
<body>
    ...
    <div class="row grid">
                    ...
                    <ul class="list-unstyled">
                        <li class="my-2">
                            ...
                            <ul class="list-unstyled ps-3 collapse" id="contents-collapse">
                                ...
                                foreach ($cat as $ct) {
                                ?>
                                    <li><a class="d-inline-flex align-items-center rounded" style="text-transform:capitalize;" href="search_result.inc.php?next_page_id=<?php echo $ct['category_name'] ?>"><?php echo $ct['category_name'] ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="col-md-10">
            ...
            <!-- Search Results Grid -->
            <h2 class="h6 pt-4 pb-3 mb-4 border-bottom" id="properties">Search Results</h2>
            <div class="row mb-3">
                <?php
                //displaying the data ---------------------------------------------------------------------------------------->
                @$page = $_GET["page"];
                ...
                $row = $property->searchProperties(1, 4, $_SESSION['search_prop_type'], $_SESSION['search_prop_district'], $page1, 8);
                if ($row) {
                    foreach ($row as $rw) {
                        ...
                        <div class="col-6 col-md-3 themed-grid-col mt-3">
                            <div class="thumb-wrapper item">
                                ...
                                <div class="thumb-content">
                                    ...
                                    <a href="search_result.inc.php?id=<?php echo $rw['prop_id']; ?>&views=<?php echo $rw['views']; ?>" class="btn btn-primary rounded-pill btn-sm">Rent now</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
            ...
            <?php
                    $cout = $property->countSearchedProperties(1, 4, $_SESSION['search_prop_type'], $_SESSION['search_prop_district']);
            ...
            ?>
            <?php for ($b = 1; $b <= $a; $b++) {  ?>
                <a href="search_result.inc.php?page=<?php echo $b; ?>" class="btn btn-primary"><span><?php echo $b . " "; ?></span></a>
            <?php }
                } else { ?>
            <div class="alert alert-danger text-center">
                <p>Sorry, nothing matches your search results!</p>
            </div>
        <?php } ?>

        </div>

        <?php include "footer2.inc.php"; ?>
        <!-- Image Modal-->
