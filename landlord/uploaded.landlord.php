        ...
        <div class="table-responsive">
            <table class="table table-striped" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $row = $warehouse->viewProperty($user_id, 1, 1, 1, 1, 1);
                    $index = 1;
                    foreach ($row as $rw) {
                        ...
                        <td>
                            <div class="btn btn-sm m-0 p-0">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-primary" href="uploaded.landlord.php?edit=<?php echo $rw['prop_id']; ?>"><span class="fas fa-edit mr-2"></span> Edit</a>
                                    <a class="dropdown-item text-danger" href="uploaded.landlord.php?del=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to delete?')"><span class="fas fa-trash-alt mr-2"></span> Remove</a>
                                </div>
                            </div>
                        </td>
                        </tr>
