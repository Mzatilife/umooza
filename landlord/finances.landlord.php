...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <!-- Begin Page Content -->
        <h2>Finances</h2>
        <p class="alert alert-danger text-center">The sent money might be less than the one potrayed here, because transaction fees will apply <br> (Mpamba or Airtel money fees or any other method used)</p>
        <hr>
        <div class="table-responsive">
            <table class="table table-striped" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    $row = $payment->viewLandlordFinances($user_id, 1, 2, 3, 4);
                    $index = 1;
                    foreach ($row as $rw) {
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="bg-primary text-white">
                                <?php
                                if ($rw['ren_status'] == 1) {
                                    echo "Money not sent to you!";
                                } elseif ($rw['ren_status'] == 2) {
                                    echo "Money sent to you!";
                                } elseif ($rw['ren_status'] == 3) {
                                    echo "Money reversal requested!";
