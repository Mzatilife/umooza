        ...
        <div class="table-responsive">
            <table class="table table-striped" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $row = $property->viewProperty($user_id, 0, 1, 2, 3, 4);
                    $index = 1;
                    foreach ($row as $rw) {
                        ...
                        echo "<td><img src='../uploads/" . $rw['image1'] . "' alt='image' width='60' height='40'></td>";
                    ?>
                        <td>
                            <?php if ($rw['status'] == 3) {
                                ...
                                <div class="btn btn-sm m-0 p-0">
                                    ...
                                    <div class="dropdown-menu">
                                        <?php
                                        if ($rw['status'] == '2') {
                                            echo "<a class='dropdown-item text-primary' href='properties.landlord.php?reas=" . $rw['prop_id'] . "'><span class='fas fa-eye mr-2'></span> View</a>";
                                        } else {
                                        }
                                        ?>
                                        <a class="dropdown-item text-primary" href="properties.landlord.php?edit=<?php echo $rw['prop_id']; ?>"><span class="fas fa-edit mr-2"></span> Edit</a>
                                        <a class="dropdown-item text-danger" href="properties.landlord.php?del=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to delete?')"><span class="fas fa-trash-alt mr-2"></span> Remove</a>
                                    </div>
                                </div>
                            <?php } ?>
                        </td>
