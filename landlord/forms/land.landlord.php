        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" class="needs-validation container mt-3" novalidate>
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="name" id="Name" placeholder="Umooza farms">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="land" value="1" required>
                        <span class="input-group-text">accres</span>
                    </div>
                    <div class="invalid-feedback">
                        Please enter the land quantity
                    </div>
                </div>
