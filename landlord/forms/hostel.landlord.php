    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" class="needs-validation container mt-3" novalidate>
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    <label for="Name" class="form-label">Hostel Name <span class="text-muted">(Optional)</span></label>
                    <input type="text" class="form-control" name="name" id="Name" placeholder="Mzembe Hostel">
                ...
                <div class="col-sm-6">
                    <label for="price" class="form-label">Rooms (Quantity)</label>
                    <div class="input-group">
                        <input type="number" class="form-control" name="quantity" value="1" min="2" required>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        Upload <b> images! (jpg, jpeg and png only)
                    </div>
