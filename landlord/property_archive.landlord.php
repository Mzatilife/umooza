        ...
        <div class="table-responsive">
            <table class="table table-striped" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $row = $property->viewProperty($user_id, 5, 5, 5, 5, 5);
                    $index = 1;
                    foreach ($row as $rw) {
                        ...
                        <td>
                            <div class="btn btn-sm m-0 p-0">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-primary" href="property_archive.landlord.php?restore=<?php echo $rw['prop_id']; ?>"><span class="fas fa-recycle mr-2"></span> Restore</a>
                                    <a class="dropdown-item text-danger" href="property_archive.landlord.php?delete=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to delete?')"><span class="fas fa-trash-alt mr-2"></span> Delete</a>
                                </div>
                            </div>
                        </td>
                    <?php
