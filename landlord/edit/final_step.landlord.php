...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <h4 class="text-primary mt-3 mb-3">Editing (Successful)</h4>
        <div class="alert alert-success fade show mt-3 text-center" role="alert">
            <p class="text-secondary" style="font-size: 16px;">You have successfully edited your item!</p>
            <p class="text-secondary" style="font-size: 16px;">Our team will review the item and you might be contacted if need be.</p>
            <p class="text-secondary mt-4" style="font-size: 16px;">THANK YOU</p>
        </div>
        <a href="../properties.landlord.php" class="btn btn-primary w-50">Finish</a>
