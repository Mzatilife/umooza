...
if (isset($_GET['del'])) {
    ...
    $result = $property->approveProperty($_GET['del'], 4);
            ...
            <table class="table table-striped" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    foreach ($row as $rw) {
                        ...
                        echo "<td><button class='p-0' data-bs-toggle='modal' data-bs-target='#image' style='border-radius: 5px;'><img src='../uploads/" . $rw['image1'] . "' alt='image' width='60' height='40'></button></td>"; ?>
                        <td>
                            ...
                            <div class="btn btn-sm m-0 p-0">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php
                                    if ($rw['status'] != '3') {
                                        echo "<a class='dropdown-item text-primary' href='properties.admin.php?view=" . $rw['prop_id'] . "'><span class='fas fa-eye mr-2'></span> View</a>";
                                    } else {
                                        echo "<span class='dropdown-item badge badge-pill badge-primary bg-primary text-white'>Rented</span>";
                                    }
                                    ?>

                                    <a class="dropdown-item text-danger" href="properties.admin.php?del=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to archive?')"><span class="fas fa-trash-alt mr-2"></span> Remove</a>
                                </div>
                            </div>
