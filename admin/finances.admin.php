...
<body>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="closed_deals.admin.php" class="btn btn-secondary">closed Deals</a>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="payments.admin.php" class="btn btn-primary">Payments</a>
            </div>
        </div>
        <?php
        if (isset($msg)) { ?>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if ($rw['ren_status'] == 1) { ?>
                            <td><a href="finances.admin.php?id=<?php echo $rw['rented_id']; ?>" class="btn btn-primary">close deal</a></td>
                            <?php } elseif ($rw['ren_status'] == 3) { ?>
                            <td><a href="finances.admin.php?rev_id=<?php echo $rw['rented_id']; ?>" class="btn btn-primary">close deal</a></td>
                            <?php } ?>
                        </tr>
                    <?php
                        $index++;
