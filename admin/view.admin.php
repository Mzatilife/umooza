    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="col mt-3">
            <div class="card">
                <div class="row g-0">
                    ...
                    <div class="col-md-4">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo ($row['type'] == 'other' || $row['type'] == 'electronic') ? $row['name'] : $row['type']; ?> Details</h5>
       ...
       src="https://www.google.com/maps/embed/v1/place?q=' . $area . '&key=AIzaSyDToXPQJU-n51dqrk6Iy7S4BYhSKE3Gzj4">
            ...
            <div class="mt-3">
                <?php
                if ($row['status'] == 4) {
                    echo "<a href='view.admin.php?restore=" . $row['prop_id'] . "' class='btn btn-sm btn-primary'>Restore</a>";
                } else {
                    if ($row['status'] != 1) {
                        echo "<a href='view.admin.php?upload=" . $row['prop_id'] . "' class='btn btn-sm btn-success'>Upload</a> ";
                    } else {
                    }
                    if ($row['status'] != 2) {
