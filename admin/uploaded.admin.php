                        ...
                        <td>
                            <div class="btn btn-sm m-0 p-0">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-primary" href="uploaded.admin.php?view=<?php echo $rw['prop_id']; ?>"><span class="fas fa-eye mr-2"></span> View</a>
                                    <a class="dropdown-item text-danger" href="uploaded.admin.php?del=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to archive?')"><span class="fas fa-trash-alt mr-2"></span> Remove</a>
                                </div>
                            </div>
                        </td>
                        </tr>
