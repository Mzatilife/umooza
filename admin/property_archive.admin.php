                        ...
                        <td>
                            ...
                            <div class="btn btn-sm m-0 p-0">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-primary" href="property_archive.admin.php?view=<?php echo $rw['prop_id']; ?>"><span class="fas fa-eye mr-2"></span> View</a>
                                    <a class=" dropdown-item text-success" href="property_archive.admin.php?restore=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to restore?')"><span class="fa fa-recycle mr-2"></span> Restore</a>
                                    <a class="dropdown-item text-danger" href="property_archive.admin.php?delete=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to delete?')"><span class="fas fa-trash-alt mr-2"></span> Delete</a>
                                </div>
                            </div>
