                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if ($rw['ren_status'] == 1) { ?>
                            <td><a href="index.finance.php?id=<?php echo $rw['rented_id']; ?>" class="btn btn-primary">close deal</a></td>
                            <?php } elseif ($rw['ren_status'] == 3) { ?>
                            <td><a href="index.finance.php?rev_id=<?php echo $rw['rented_id']; ?>" class="btn btn-primary">close deal</a></td>
                            <?php } ?>
                        </tr>
                    <?php
                        $index++;
