        ...
        <div class="row border-bottom pb-3 mb-3 mt-3">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="uploaded.liaising.php" class="btn btn-sm btn-primary">View</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <?php
                        ...
                        ?>
                        <h5 class="card-title">Total: <span class="badge rounded-pill bg-secondary"><?php echo $rejected; ?></span></h5>
                    </div>
                    <div class="card-footer">
                        <a href="rejected.liaising.php" class="btn btn-sm btn-primary">View</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="rented.liaising.php" class="btn btn-sm btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped table-sm" id="example">
                ...
                <tbody>
                    ...
                    foreach ($row as $rw) {
                        ...
                        <td><a href='index.liaising.php?view=" . $rw['prop_id'] . "' class='btn btn-sm btn-primary'>View</a></td>
                    </tr>";
