                        ...
                        <td>
                            <div class="btn btn-sm m-0 p-0">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php
                                    if ($rw['status'] != '3') {
                                        echo "<a class='dropdown-item text-primary' href='properties.liaising.php?view=" . $rw['prop_id'] . "'><span class='fas fa-eye mr-2'></span> View</a>";
                                    } else {
                                        echo "<span class='dropdown-item badge badge-pill badge-primary bg-primary text-white'>Rented</span>";
                                    }
                                    ?>

                                    <a class="dropdown-item text-danger" href="properties.liaising.php?del=<?php echo $rw['prop_id']; ?>" onclick="return confirm('are you sure you want to delete?')"><span class="fas fa-trash-alt mr-2"></span> Remove</a>
                                </div>
                            </div>
